...
class SNode:
    ...
    def __str__(self):
        """Returns a string with the node as its elem and what´s next"""
        if self.next is not None:
            result = "node element: " + str(self.elem) + " next element: " + str(self.next.elem)
        else:
            result = "node element: " + str(self.elem) + " next element: NONE"
        return result

    def __repr__(self):
        """Returns a reference in string form of each element of the list"""
        if self.next is not None:
            result = "node element: " + str(self.elem) + "next element: " + str(self.next.elem)
        else:
            result = "node element: " + str(self.elem) + " next element: NONE"
