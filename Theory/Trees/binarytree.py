...
"""Every function in this class with an underscore is done to work with any node of the tree. The function 
      without the underscore is done to work with the root node"""
class BinaryTree:
    def __init__(self):
        """creates an empty binary tree"""
        self._root=None

    # FOR SIZE,HEIGHT AND DEPTH FUNCTIONS
    # Recursive function. It sums one from every node that it goes through. The next iteration is done
    # on children.
    def size(self):
